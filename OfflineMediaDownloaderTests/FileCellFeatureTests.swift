...
struct FileCellFeatureTests {
  ...
  @MainActor
  @Test("Delete button triggers CoreData, filesystem, and thumbnail cache removal")
  ...
  func isNotPendingWhenUrlPresent() {
